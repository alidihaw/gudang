...
$(function() {
    ...
    $('#world-map').vectorMap({
        ...
        series: {
            regions: [{
                    values: visitorsData,
                    scale: ["#FFE700", "#2D79A6"], //['#3E5E6B', '#A6BAC2'],
        ...
        events: [
            {
                ...
                backgroundColor: "#FFE700", //light-blue 
                borderColor: "#FFE700" //light-blue
            },
            {
                title: 'Long Event',
