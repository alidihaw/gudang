		...
		<div class="col-xs-12">
			<div class="box">
				<div class="box-body table-responsive">
					...
					<form id="formMenu" action="<?php echo site_url();?>pengaturan/edit_password" method="post" onSubmit="return validate()">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-bordered table-hover">
							...
							<tr>
								...
								<td><input name="admin_pass_ulang" type="password" id="admin_pass_ulang" value="" size="30" maxlength="50" onkeyup="checkPass(); return false;"
									/><span id="confirmMessage" class="confirmMessage" style="font-size:12px; font-weight: bold; padding-left: 10px;"></span></td>
							</tr>
						</table>
						<div style="padding:20px 0 0 0px; text-align:center"><input class="btn btn-primary" type="submit" name="simpan" value="Simpan" />&nbsp;<input class="btn btn-primary" type="reset"
							    name="batal" value="Batalkan" onclick="location.href='<?php echo site_url();?>pengaturan/pengguna'" /></div>
					</form>
				</div>
			</div>