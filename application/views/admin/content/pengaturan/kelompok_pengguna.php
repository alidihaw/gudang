...
<section class="content">
	...
	?>
							<tr>
								...
								<td align="center"><a href="<?php echo site_url();?>pengaturan/kelompok_pengguna/edit/<?php echo $row->admin_level_kode;?>" class="edit"
									    title="edit"></a><a href="<?php echo site_url();?>pengaturan/kelompok_pengguna/hapus/<?php echo $row->admin_level_kode;?>"
	...
	?>
							...
							<tr>
								<th colspan="6" align="left">TOTAL :
									<?php echo $jml_data;?><span id="pages"><?php if ($jml_halaman > 1){ echo pages($halaman, $jml_halaman, 'pengaturan/kelompok_pengguna/view', $id=""); }?></span></th>
							</tr>
						</tbody>
					</table>
				</div>
									...
									<form id="formMenu" action="<?php echo site_url();?>pengaturan/kelompok_pengguna/tambah" method="post" onSubmit="return validate()">
										<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-bordered table-hover">
											<tr>
												...
												<td><input name="admin_level_nama" type="text" class="form-control input-sm" id="admin_level_nama" value="" size="30"
													    maxlength="30" /></td>
											</tr>
										</table>
										<div style="padding:20px 0 0 0px; text-align:center"><input class="btn btn-primary" type="submit" name="simpan" value="Simpan Data" />&nbsp;<input class="btn btn-primary"
											    type="reset" name="batal" value="Batalkan" onclick="location.href='<?php echo site_url();?>pengaturan/kelompok_pengguna'"
											/></div>
									</form>
								</div>
							</div>
											...
											<div class="box-body table-responsive">
												...
												<form id="formMenu" action="<?php echo site_url();?>pengaturan/kelompok_pengguna/edit" method="post" onSubmit="return validate()">
													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-bordered table-hover">
														<tr>
															<td><label for="admin_level_nama">Kelompok <span class="required">*</span></label></td>
															<td><input name="admin_level_nama" type="text" class="form-control input-sm" id="admin_level_nama" value="<?php echo $admin_level_nama; ?>"
