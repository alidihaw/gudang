        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-body table-responsive">
                    ...
                    <?php } ?>
                    <form role="form" id="formMenu" action="<?php echo site_url();?>website/identitas/edit/<?php echo $identitas_id;?>" method="post"
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-bordered table-hover">
                            <tr>
                                ...
                                <td><input type="text" name="identitas_website" class="form-control input-sm" id="identitas_website"
                                        value="<?php echo $identitas_website; ?>" /></td>
                            </tr>
                            <tr>
                                <td><label for="identitas_deskripsi">Meta Deskripsi <span class="required">*</span></label></td>
                                <td><input type="text" name="identitas_deskripsi" class="form-control input-sm" id="identitas_deskripsi"
                                        value="<?php echo $identitas_deskripsi; ?>" size="100" /></td>
                            </tr>
                            <tr>
                                <td><label for="identitas_keyword">Meta Keyword <span class="required">*</span></label></td>
                                <td><input type="text" name="identitas_keyword" class="form-control input-sm" id="identitas_keyword"
                                        value="<?php echo $identitas_keyword; ?>" size="100" /></td>
                            </tr>
                            <tr>
                                <td><label for="identitas_alamat">Alamat <span class="required">*</span></label></td>
                                <td><input type="text" name="identitas_alamat" class="form-control input-sm" id="identitas_alamat"
                                        value="<?php echo $identitas_alamat; ?>" size="50" /></td>
                            </tr>
                            <tr>
                                <td><label for="identitas_notelp">No.Telepon <span class="required">*</span></label></td>
                                <td><input type="text" name="identitas_notelp" class="form-control input-sm" id="identitas_notelp"
                                        value="<?php echo $identitas_notelp; ?>" size="20" maxlength="15" /></td>
                            </tr>
                            <tr>
                                <td><label for="identitas_email">Email <span class="required">*</span></label></td>
                                <td><input type="text" name="identitas_email" class="form-control input-sm" id="identitas_email"
                                        value="<?php echo $identitas_email; ?>" size="50" /></td>
                            </tr>
                            <tr>
                                <td><label for="identitas_fb">Facebook <span class="required">*</span></label></td>
                                <td><input type="text" name="identitas_fb" class="form-control input-sm" id="identitas_fb" value="<?php echo $identitas_fb; ?>"
                                        size="50" /></td>
                            </tr>
                            <tr>
                                <td><label for="identitas_tw">Twitter <span class="required">*</span></label></td>
                                <td><input type="text" name="identitas_tw" class="form-control input-sm" id="identitas_tw" value="<?php echo $identitas_tw; ?>"
                                        size="50" /></td>
                            </tr>
                            <tr>
                                <td><label for="identitas_gp">Google Plus <span class="required">*</span></label></td>
                                <td><input type="text" name="identitas_gp" class="form-control input-sm" id="identitas_gp" value="<?php echo $identitas_gp; ?>"
                                        size="50" /></td>
                            </tr>
                            <tr>
                                <td><label for="identitas_yb">Youtube <span class="required">*</span></label></td>
                                <td><input type="text" name="identitas_yb" class="form-control input-sm" id="identitas_yb" value="<?php echo $identitas_yb; ?>"
                                        size="50" /></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><input type="file" name="identitas_favicon" class="form-control input-sm" id="identitas_favicon"
