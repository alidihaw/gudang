    ...
    series: [{
        ...
        data: [
			...
			<?php } ?>
						...
						<a href="<?php echo base_url();?>website/laporankeluarpdf" class="btn btn-primary btn-block btn-lg" style="margin-top: 30px !important;">Download Laporan Barang Keluar PDF</a>
