...
<section class="content-header">
	<h1>Transaksi<small> Barang Keluar</small></h1>
	<ol class="breadcrumb">
			...
			<div class="box">
				<div class="box-body table-responsive">
					<div id="opration">
						...
						<div class="bttns_add">
							<ul>
								<li><a class="addbttn last" href="<?php echo site_url();?>website/keluar/tambah">Tambah Barang Keluar</a></li>
							</ul>
						</div>
						<?php } ?>
						<div class="bttns_clear">
							<ul>
								<li><a class="clrttn last" href="<?php echo site_url();?>website/keluar">Bersihkan Pencarian</a></li>
							</ul>
						</div>
					</div>
					<div class="clear"></div>
	...
	?>
							...
							<tr>
								<th colspan="6" align="left">TOTAL :
									<?php echo $jml_data;?><span id="pages"><?php if ($jml_halaman > 1){ echo pages($halaman, $jml_halaman, 'website/keluar/view', $id=""); }?></span></th>
							</tr>
						</tbody>
					</table>
				</div>
				...
				<section class="content-header">
					...
					<ol class="breadcrumb">
						<li><a href="<?php echo base_url();?>admin"><i class="fa fa-dashboard"></i> Home</a></li>
						<li><a href="<?php echo base_url();?>website/keluar">Transaksi Barang Keluar</a></li>
						...
						<div class="col-xs-12">
							<div class="box">
								<div class="box-body table-responsive">
									...
									<form id="formMenu" action="<?php echo site_url();?>website/keluar/tambah" method="post" onSubmit="return validate()">
										...
										<tr>
												...
												<?php foreach ($this->ADM->grid_all_barang('', 'id_barang', 'DESC', 100, '', '' , '') as $barang){ ?>
													<option value="<?php echo $barang->id_barang ?>"><?php echo $barang->nama_barang ?> - Stock : <?php echo $barang->stock ?></option>
												<?php } ?>
												</select></td>
											</tr>

											<tr>
												<td><label for="id_customer">Nama Customer <span class="required">*</span></label></td>
												<td><select name="id_customer" class="form-control input-sm">
