...
<head>
    <meta charset="UTF-8">
    <title>LOGIN |
        <?php echo strtoupper($web->identitas_website);?>
    </title>
...
<body onLoad="document.getElementById('user').focus()" class="bg-black">
    <div class="form-box" id="login-box">
        <div class="header"><img src="<?php echo base_url();?>assets/<?php echo $web->identitas_favicon;?>"></div>
        <form action="<?php echo site_url();?>login/ceklogin" method="post" name="formLogin" id="form" onSubmit="return validate()">
